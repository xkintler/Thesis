...
\begin{equation*}
	...
	\end{pmatrix}.
\end{equation*}
% RP: Tu to vyznie akoby ste to "zahravali do outu". Ja by som tam oddal, ze nieco ako pre rozumne rady modelov, tato optimalizacia nemusi byt nutne narocna.
...
\begin{figure}
    % RP: Musim Vas pochvalit za obrazky. Prvotriedna kvalita.
	\centering
...
% RP: Tento odsek je fajn, ale myslim, ze podobny by mal aj v niektorej z predchadzajucich kapitol. Problem je, ze to nie uplne dobre mixovat priklad a teoriu...inak povedane, nemalo by sa stat, ze sa citatel dozvie ako nieco urobit s kapitoly, ktora sa vola "Priklady identifikiacie"
...
\begin{figure}
	\centering
	% RP: Pridal by som do obrazka legendu. Vyrazne to zlepsi jeho prehladnost. (Toto aj o vsetkych dalsich obrazkoch s viacerymi ciarami)
...
% RP: Trochu tu chybaju Pareto fronty. Clovek by to cakal potom co ste ich tak zaujimavo opisali.
