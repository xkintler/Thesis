...
% RP: Preco vzdy davate medzeru pred otaznik? 
...
% RP: Je dobre dat vzdy medzi textom a referenciou nedelitelnu medzeru
modelovaniu~\cite{mishra:data_modeling:2018}.

Raz uviedol známy matematik a štatistik George E.P. Box  v jednej z jeho publikácii nasledovný citát: \aps{\textit{Všetky modely sú
% RP: skor "nespravne" alebo "chybne" ako "zlé"
zlé, ale niektoré sú užitočné.}} \cite{box:sas:1976}. Nejde iba o slaboduchú dehonestáciu dátového modelovania. Týmto citátom chcel vyjadriť skutočnosť, že samotné modely, už z definície, sú iba aproximáciami neznámej reality
% RP: ---
...
\begin{equation}
	v(t) = F(q)e(t),
	% RP: e(t) je sum? Treba to jasne definovat.
\end{equation}
...
\end{equation}
Zatiaľ čo
% RP: tomuto nerozumiem "AR sa venuje regresnej časti". Za mna je to opis dynamiky vystupu.
...
\newline
 ...
 % RP: Nie je prepojenie medzi "v" a "e" a medzi "y" a "u". "y" a "u" nie su ani definovane.
 \begin{equation}
 ...
 \begin{equation}
    ...
    % RP: Tej poslednej casti "\left(+ e(t)\right)" nerozumiem. To je asi preklep lebo teraz to vyzera, ze e vynasobi b_nb*u(t-nb).
	 \end{split}
	 \label{eq:ARX_m} 
 \end{equation}
 ...
 \begin{equation}
 	...
 	% RP: Je toto F(q) to iste F(q) ako v (1.2)? Nezda sa mi, ale nepatam si tieto definicie z hlavy. Ak nie, tak by sa to nemalo volat rovnako lebo je to zavadzajuce.
 \end{equation}
