...
% RP: "stav, ktorý nepretržito pracuje" je zvlastne vyjadrenie
...
% RP: Velmi tazko sa sleduje obrazok a tato diskusia. Mali by ste sa na obrazok odkazovat konkretnejsie (napr. vyrazy ako "dana cervenou trajektoriou" by znacne pomohli)
Model s inhibíciou vykazuje odlišné správanie. Na fázovom diagrame (Obr. \ref{fig:fazovy_haldane} napravo) môžeme sledovať už dva nenulové stavy a jeden nulový. Výsledkom triviálneho riešenia je \aps{výplach}, ktorý vedie k nulovej koncentrácii biomasy. Ako si môžeme všimnúť, vždy keď je rýchlosť rastu biomasy pomalšia ako je odtok suspenzie zo systému, dostaneme sa do výplachu. Ostali dva netriviálne stavy, z ktorých jeden je nestabilný a druhý je stabilný. V okolí nestabilného stavu môžu nastať dva prípady a to v závislosti od počiatočných podmienok. Ak sa na Obr. \ref{fig:spec_rychl_rastu} nachádzame v okolí nestabilného stavu od neho
% RP: "Nalavo"/"napravo" nie su uplne presne. mali by byt doplnene o informaciu o hodnote danej premennej/premennych
...
% RP: Chyba tu nejake strucne poukazanie na rozmanitost dynamickeho spravania a akesi spojenie s temou prace. Inak tato cast vyzera dost samoucelna. Nieco ako "Je ocividne, ze ak na optimalizaciu alebo riadenie pouzijeme nespravny model, mozeme velmi lahko dosiahnut uplne opacny efekt, ako zamyslame. Preto je tento model zvoleny na demostraciu hybridneho modelovania." ale kludne aj trochu rozvite.
