...
% RP: Pridal by som aspon po jednom odkaze na litaraturu do prvych styroch odsekov.

% RP: Tato veta je dlha aj na slovencinu.
...
% RP: A kde je varenie piva? :) Just joking.
...
% RP: Tu by mala byt presne ta pomlcka (vid. komenty k angl. abstraktu) ---
-- jednak štruktúra zariadenia a jednak stupeň automatizácie, 
% RP: ...a tu by mal byt namiesto ciarky tiez
...
% RP: Tejto vete nerozumiem. V akom zmysle "robustne"? Co znamena "kratkodoba predikcia"?
...
% RP: Este by som doplnil, kde/ako sa pouzije garantovany odhad.
...
% RP: Z tohto odesku dajak nic nevyplyva...clovek by tu ocakaval ze poviet aspon, ze biochemicke reaktory teda predstavuju zaujimavu oblast na studium

% RP: Mali by ste este pridat aj to ako je praca rozclenena a co kde clovek najde.
