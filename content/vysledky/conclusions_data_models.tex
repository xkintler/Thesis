...
% RP: "vztiahnuté na model" -> "vztiahnuté na vysledky dosiahnute pre model"
...
% RP: skor nieco "z dovodu kompletnosti vysledkov" nez "z didaktických účelov"
...
\centering
	\begin{subfigure}[b]{0.49\textwidth}
		...
		% RP: Nie je uplne zrejme preco je tu priebeh nominalneho modelu a vystupu zo zariadenia ine ako na obr. 5.3. Nezhorsuje to vzajomne porovnanie?
		\caption{Časový priebeh koncentrácie substrátu.\newline}
